...
def index(request):
    ...
    send_mail(
        'Email template',
        'context',
        'abhishek.p@indictranstech.com',
        ['prakashabhishek32@gmail.com'],
        fail_silently=False
        
        # 'support@indictranstech.com',  # TODO: Update this with your mail id
        # ['abhishek.p@indictranstech.com'],  # TODO: Update this with the recipients mail id
